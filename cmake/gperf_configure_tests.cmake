...
if(HAVE_SIG_ATOMIC_T)
  ...
  if(EXISTS "${HAVE_SIGNED_SIG_ATOMIC_T_OUTPUT_FILE}")
    ...
    if(HAVE_SIGNED_SIG_ATOMIC_TRESULT)
      message(FATAL_ERROR "Failed to run the HAVE_SIGNED_SIG_ATOMIC_T check program.")
    else()
    ...
    message(FATAL_ERROR "Source file for HAVE_SIGNED_SIG_ATOMIC_T check does not exist.")
  endif()
